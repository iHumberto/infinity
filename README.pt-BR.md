...
👉 [Guia completo de configuração](docs/pt-BR/CUSTOMIZATION.md)
...
- [Guia de Uso](docs/pt-BR/USAGE.md) — como instalar e usar o tema
- [Guia de Customização](docs/pt-BR/CUSTOMIZATION.md) — como customizar cores, fontes e slideshow
- [FAQ](docs/pt-BR/FAQ.md) — perguntas frequentes
